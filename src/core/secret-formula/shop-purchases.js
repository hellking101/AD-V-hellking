...
export const shopPurchases = {
  ...
  allDimPurchases: {
    ...
    multiplier: purchases => (purchases.gt(4) ? Decimal.add(32,purchases.sub(5).mul(200000000)) : Decimal.pow(200000000, purchases)),
  ...
  IPPurchases: {
    ...
    multiplier: purchases => (purchases.eq(0) ? DC.D1 : purchases.mul(200000000)),
    formatEffect: x => `×${x.toFixed(0)}`,
  ...
  replicantiPurchases: {
    ...
    multiplier: purchases => (purchases.eq(0) ? DC.D1 : purchases.mul(200000000).add(1)),
  ...
  RMPurchases: {
    ...
    multiplier: purchases => purchases.mul(200000000).add(100),
    formatEffect: x => `×${x.toFixed(0)}`,
